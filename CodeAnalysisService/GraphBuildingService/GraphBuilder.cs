...
using CodeAnalysisService.GraphBuildingService.NodeBuilder;
using CodeAnalysisService.GraphBuildingService.EdgeBuilder;
...
namespace CodeAnalysisService.GraphBuildingService
{
    ...
    public class GraphBuilder
    {
        ...
        public GraphBuilder(Dictionary<SyntaxTree, SemanticModel> semanticModels)
        {
        ...
        // Method to ensure nodes are always build before edges.
